<template>
	<div
		class="flex gap-[32px] min-h-0 max-[800px]:flex-col max-[800px]:h-fit max-[800px]:min-h-full"
	>
		...
		>
			<div
				class="flex flex-col place-content-between p-[64px] max-[800px]:p-[32px] h-full w-full"
			>
				...
				<div class="hidden flex-col gap-[16px]">
